...
docker run -d -p 8002:80 -P --name="consul1" --hostname="consul1" "untoldwind/dose:consul-boot-v2"
docker run -d -P --name="consul2" --link consul1:consul1 --hostname="consul2" "untoldwind/dose:consul-v2"
docker run -d -P --name="consul3" --link consul1:consul1 --hostname="consul3" "untoldwind/dose:consul-v2"
